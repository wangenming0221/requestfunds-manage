<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="userName" label="操作人" width="300" align="center"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        logService.getSysUserLogList(this.addDateRange(this.queryParams, this.dateRange)).then(res => {
