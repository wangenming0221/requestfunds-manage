<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="操作人名称" prop="portalName">
        <el-input
...
<script>
  ...
  export default {
    ...
    methods: {
      showPop(value) {
        this.open = true;
        this.details = value.requestParams;
      },
      /** 查询菜单列表 */
      getList() {
        this.loading = true;
        logService.getBpmLogList(this.addDateRange(this.queryParams, this.dateRange)).then(res => {
