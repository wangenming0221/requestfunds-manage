<template>
  <div class="app-container">
    ...
    <el-table class="done-table" border v-loading="loading" :data="menuList" max-height="450" @row-click="clickRow" >
      <el-table-column prop="workFlowName" label="流程名称" width="400" fixed align="center"></el-table-column>
      <el-table-column prop="periods" label="期数" width="400" fixed align="center"></el-table-column>
      <el-table-column prop="stayTime" label="停留时间" width="400" fixed align="center"></el-table-column>
      <el-table-column prop="busName" label="请款类型" align="center" width="200"></el-table-column>
      <el-table-column prop="contractCode" label="合同编码" align="center" width="300"></el-table-column>
      <el-table-column prop="contractName" label="合同名称" align="center" width="300"></el-table-column>
      <el-table-column prop="createTime" label="申请时间" align="center" width="400"></el-table-column>
      <el-table-column prop="approvalStatus" label="审批状态" align="center" width="300">
      ...
      <el-table-column prop="userName" label="发起人姓名" width="200"  align="center"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        request.getMyDoneFromBpm(params).then(res => {
