<template>
  <div class="app-container">
    <el-form ref="financeParkForm" :model="form" label-width="150px" :rules="rules">
      ...
      <el-row :gutter="24" class="row">
        ...
        <el-col :span="20" class="col">
          <el-form-item prop="projectCode" label-width= '0'>
            <el-input v-model="form.projectCode"  placeholder="请输入总包项目编码"/>
          </el-form-item>
        </el-col>
        <el-col :span="4" class="col">
          项目名称
        ...
        <el-col :span="20" class="col">
          <el-form-item prop="contractCode" label-width= '0'>
            <el-input v-model="form.contractCode"  placeholder="请输入总包合同编码"/>
          </el-form-item>
        </el-col>
        <el-col :span="4" class="col">
          财务苑区
        ...
        <el-col :span="20" class="col">
          <el-form-item prop="parkName" label-width= '0'>
            <el-input v-model="form.parkName"  placeholder="请输入财务苑区"/>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
<script>
  ...
  export default {
    ...
    mounted() {
      if (this.$route.query.id) {
        ...
        projectInfo.getFinanceParkDetail({ id: this.$route.query.id }).then(res => {
          ...
          this.$nextTick(() => {
            this.clearForm('financeParkForm');
          })
        })
      } else {
        this.type = 'add';
    ...
    methods: {
      ...
      addForm(value) {
        projectInfo.addFinancePark(value).then(res => {
          if (res.code === 0) {
            this.$message({
              type: 'success',
              message: '操作成功'
      ...
      editForm(value) {
        projectInfo.editFinancePark(value).then(res => {
          if (res.code === 0) {
            this.$message({
              type: 'success',
              message: '操作成功'
