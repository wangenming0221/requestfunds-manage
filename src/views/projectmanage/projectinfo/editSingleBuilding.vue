<template>
  <div class="app-container">
    <!-- 新增/编辑弹框 -->
     <el-dialog  title="楼栋信息"  :visible.sync="visible"  width="1060px"  :before-close="cancelSubmitForm">
       <el-form ref="singleBuildingForm" :model="form" label-width="150px" :rules="rules" style="height:600px;overflow: auto;">
         <el-row :gutter="24" style="width:calc(100% - 10px)">
           ...
           <el-col :span="8">
             <el-form-item prop="area" label="总面积">
               <el-input v-model.number="form.area"  placeholder="请输入总面积"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="isMobilization" label="是否已进场(截至立项发起日)">
               <el-select v-model="form.isMobilization" placeholder="请选择是否已进场(截至立项发起日)">
           ...
           <el-col :span="8">
             <el-form-item prop="buildingContractor" label="楼栋承包人">
               <el-input v-model="form.buildingContractor"  placeholder="请输入楼栋承包人"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="phaseStatus" label="所处阶段">
               <el-select v-model="form.phaseStatus" placeholder="请选择所处阶段">
           ...
           <!-- <el-col :span="8">
             <el-form-item prop="generalContractorProjectName" label="总包项目名称">
               <el-input v-model="form.generalContractorProjectName"  placeholder="请输入总包项目名称"/>
             </el-form-item>
           </el-col> -->
           <el-col :span="8">
             <el-form-item prop="planBuildingName" label="规划楼栋名称">
               <el-input v-model="form.planBuildingName"  placeholder="请输入规划楼栋名称"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="stageName" label="分期名称">
               <el-input v-model="form.stageName"  placeholder="请输入分期名称"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="unitCount" label="单元数">
               <el-input v-model.number="form.unitCount"  placeholder="请输入单元数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="formworkExpansionCoefficient" label="模板展开系数">
               <el-input v-model="form.formworkExpansionCoefficient"  placeholder="请输入模板展开系数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="aboveFloorCount" label="地上总层数">
               <el-input v-model.number="form.aboveFloorCount"  placeholder="请输入地上总层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="underFloorCount" label="地下总层数">
               <el-input v-model.number="form.underFloorCount"  placeholder="请输入地下总层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="businessType" label="产品类型/业态">
               <el-input v-model="form.businessType"  placeholder="请输入产品类型/业态"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="houseTypeCode" label="户型编码">
               <el-input v-model="form.houseTypeCode"  placeholder="请输入户型编码"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="houseTypeName" label="户型名称">
               <el-input v-model="form.houseTypeName"  placeholder="请输入户型名称"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
           ...
           <el-col :span="8">
             <el-form-item prop="totalStopHours" label="累计停工时长">
               <el-input v-model.number="form.totalStopHours"  placeholder="请输入累计停工时长"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="completedFloorCount" label="施工完成层数">
               <el-input v-model.number="form.completedFloorCount"  placeholder="请输入施工完成层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="masonryFloorCount" label="当前砌筑施工层数">
               <el-input v-model.number="form.masonryFloorCount"  placeholder="请输入当前砌筑施工层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="internalPlasterFloorCount" label="当前内抹施工层数">
               <el-input v-model.number="form.internalPlasterFloorCount"  placeholder="请输入当前内抹施工层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="subjectFloorCount" label="当前主体施工层数">
               <el-input v-model.number="form.subjectFloorCount"  placeholder="请输入当前主体施工层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="buildingStandardArea" label="楼栋标准层面积(m²)">
               <el-input v-model.number="form.buildingStandardArea"  placeholder="请输入楼栋标准层面积"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="buildingCompletedArea" label="楼栋已完成施工面积(m²)">
               <el-input v-model.number="form.buildingCompletedArea"  placeholder="请输入楼栋已完成施工面积"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="completedTotalProportion" label="主体施工完成层数/总层数">
               <el-input v-model.number="form.completedTotalProportion"  placeholder="请输入主体施工完成层数/总层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="templateSystem" label="模板体系">
               <el-select v-model="form.templateSystem" placeholder="请选择模板体系">
           ...
           <el-col :span="8">
             <el-form-item prop="outerFrameSystem" label="外架体系">
               <el-select v-model="form.outerFrameSystem" placeholder="请选择外架体系">
           ...
           <el-col :span="8">
             <el-form-item prop="singleFloorBuildArea" label="单层建筑面积（标准/非标准层平均面积)">
               <el-input v-model.number="form.singleFloorBuildArea"  placeholder="请输入单层建筑面积"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="isRobotConstruction" label="机器人施工">
               <el-select v-model="form.isRobotConstruction" placeholder="请选择机器人施工">
           ...
           <el-col :span="8">
             <el-form-item prop="threeGuaranteeType" label="三保类型">
               <el-select v-model="form.threeGuaranteeType" placeholder="请选择三保类型">
           ...
           <el-col :span="8">
             <el-form-item prop="innerFrameSystem" label="内架体系">
               <el-input v-model="form.innerFrameSystem"  placeholder="请输入内架体系"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="decorationStandard" label="装修标准">
               <el-input v-model="form.decorationStandard"  placeholder="请输入装修标准"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="deliveryStageParta" label="甲方交楼分期">
               <el-input v-model="form.deliveryStageParta"  placeholder="请输入甲方交楼分期"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="hasNewSystemCondition" label="是否具备新体系施工条件">
               <el-select v-model="form.hasNewSystemCondition" placeholder="请选择是否具备新体系施工条件">
                 <el-option v-for="item in trueOrFalseOptions"
                            :key="item.id"
                            :label="item.name"
                            :value="item.id">
           ...
           <el-col :span="8">
             <el-form-item prop="scheduleManagement" label="进度管理人员">
               <el-input v-model="form.scheduleManagement"  placeholder="请输入进度管理人员"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="buildingConstructStatus" label="楼栋施工状态">
               <el-select v-model="form.buildingConstructStatus" placeholder="请选择楼栋施工状态">
           ...
           <el-col :span="8">
             <el-form-item prop="yearPlanFloors" label="本年度计划施工层数">
               <el-input v-model.number="form.yearPlanFloors"  placeholder="请输入本年度计划施工层数"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="yearPlanArea" label="本年度计划施工面积">
               <el-input v-model.number="form.yearPlanArea"  placeholder="请输入本年度计划施工面积"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="buildingNowProcedureName" label="当前工序">
               <el-input v-model="form.buildingNowProcedureName"  placeholder="请输入当前工序"/>
             </el-form-item>
           </el-col>
           <el-col :span="24" class="common-title">甲方相关信息</el-col>
           <el-col :span="8">
             <el-form-item prop="projectPlanOutput" label="甲方项目部计划输出">
               <el-input v-model="form.projectPlanOutput"  placeholder="请输入甲方项目部计划输出"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="projectPlanOutputRemark" label="甲方项目部计划输出(备注)">
               <el-input v-model="form.projectPlanOutputRemark"  placeholder="请输入甲方项目部计划输出(备注)"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="regionPlanOutput" label="甲方区域大运营计划输出">
               <el-input v-model="form.regionPlanOutput"  placeholder="请输入甲方区域大运营计划输出"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
           ...
           <el-col :span="8">
             <el-form-item prop="preSaleImage" label="预售形象">
               <el-input v-model="form.preSaleImage"  placeholder="请输入预售形象"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
           ...
           <el-col :span="8">
             <el-form-item prop="currentCompletionStatus" label="当前竣备完成情况">
               <el-input v-model="form.currentCompletionStatus"  placeholder="请输入当前竣备完成情况"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="currentInspectStatus" label="当前联验完成情况">
               <el-input v-model="form.currentInspectStatus"  placeholder="请输入当前联验完成情况"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="currentDeliverEvaluationStatus" label="当前交付测评完成情况">
               <el-input v-model="form.currentDeliverEvaluationStatus"  placeholder="请输入当前交付测评完成情况"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="currentDeliverOwerStatus" label="当前交付小业主完成情况">
               <el-input v-model="form.currentDeliverOwerStatus"  placeholder="请输入当前交付小业主完成情况"/>
             </el-form-item>
           </el-col>
           <el-col :span="24" class="common-title">MDG楼栋信息</el-col>
           <el-col :span="8">
             <el-form-item prop="mdgName" label="MDG楼栋名称">
               <el-input v-model="form.mdgName"  placeholder="请输入MDG楼栋名称"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="mdgCode" label="MDG楼栋编码">
               <el-input v-model="form.mdgCode"  placeholder="请输入MDG楼栋编码"/>
             </el-form-item>
           </el-col>
           <el-col :span="8">
             <el-form-item prop="mdgNameProject" label="MDG项目名称">
               <el-input v-model="form.mdgNameProject"  placeholder="请输入MDG项目名称"/>
             </el-form-item>
           </el-col>
         </el-row>
       </el-form>
       <div slot="footer" class="dialog-footer">
         <el-button :disabled="loading" @click="cancelSubmitForm">取 消</el-button>
         <el-button type="primary" :disabled="loading" @click="verifySubmitForm">确 定</el-button>
       </div>
     </el-dialog>
    ...
    methods: {
      ...
      verifySubmitForm(){
        this.$refs['singleBuildingForm'].validate((valid) => {
          if (valid) {
            this.$emit("commitFloor",this.form);
